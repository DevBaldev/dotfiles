...
config.set(
    ...
    True,
    "file:///home/main/.local/share/qutebrowser/userscripts/*",
)
...
config.bind(",d", "spawn --detach ghostty -e yt-dlp {url}")
config.bind(",M", "hint links spawn --detach mpv {hint-url}")
config.bind(",D", "hint links spawn --detach ghostty -e yt-dlp {hint-url}")
